...
const FusionStyle = styled('div', {fontSize: '80px', color: '#4db5d9', paddingLeft: '500px', paddingRight: '30px'})
const FullHeightDiv = styled('div', { height: '100%', backgroundColor: '#FFFFFF'});
const Circle = styled('div', {height: '180px', width: '180px', marginTop: '20px', backgroundColor: '#f0f8fa', ':hover': {backgroundColor: 'white'}, border: '10px solid #4db5d9',  borderRadius: '50%', display: 'flex', justifyContent: 'center', alignItems: 'center'});
...
const GettingStartedLink = styled('a', {textDecoration: 'none', color: '#4db5d9', fontSize: '18px', display: 'flex', justifyContent: 'center', alignItems: 'center', textAlign: 'center', height: '100%'});
